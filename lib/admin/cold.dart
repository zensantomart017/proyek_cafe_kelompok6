...
class _ColdScreenState extends State<ColdScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> addProduct(String name, String description, String image, double price) async {
    try {
      await FirebaseFirestore.instance.collection('cold').add({
        'name': name,
  ...
  Future<void> updateProduct(String id, String name, String description, String image, double price) async {
    try {
      await FirebaseFirestore.instance.collection('cold').doc(id).update({
        'name': name,
        'description': description,
        'image': image,
        'price': price,
  ...
  Future<void> deleteProduct(String id) async {
    try {
      await FirebaseFirestore.instance.collection('cold').doc(id).delete();
  ...
  Widget buildProductList() {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('cold').snapshots(),
